		...
		<div class="col-lg-12" style="padding: 2px; margin-bottom: 20px; border:1px solid #D6D6D6">
			<div class="thumbnail col-lg-12" style="border:0; margin:0; padding-left: 0; padding-right:0 ;">
				<a class="home-last-news-link" href="<?= get_post_permalink(); ?>">
					...
					<span class="single-administracao-date">
						<i class="fa fa-calendar"></i>
						<?php echo get_the_date( 'd/m/Y' ); ?>
					</span>

					<h2 class="single-administracao-title col-lg-10" style="">
						<?php the_title(); ?>
					</h2>
					<div class=" single-administracao-resumo col-lg-10"><?php the_excerpt(); ?></div>
					<a href="<?= get_post_permalink(); ?>" class="btn btn-default single-administracao-btn">Ver Mais</a>
