...
<main class="conteudo col-lg-12">
	...
	<section class="post-panel col-lg-12 justify-content-center row">
		...
		<div class="post-content col-lg-8 mt-4 ">
			<div class=" pl-4 pt-2 pr-4 border  border-light bg-white rounded-0" style="box-shadow:rgba(0,0,0,.2) 0 4px 16px;">
	...
	<div class="mt-2 col-lg-4 border border-light bg-white p-2 mt-4" style="box-shadow:rgba(0,0,0,.2) 0 4px 16px;">
		<header class="col-lg-12 bg-dark p-1 pt-2 mb-2">
		...
		<?php  foreach ($noticias_post as $post): ?>
			<article class="list-group mb-2 m-auto mr-0 p-0 home-news-article col-lg-12">
				...
				<a href="<?= get_permalink() ?>" class="list-group-item-hover list-group-item list-group-item-action flex-column align-items-start rounded-0 mb-2">
