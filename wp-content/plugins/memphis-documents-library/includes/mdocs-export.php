	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<form action="" method="post" id="mdocs-export">
				<input type="button" onclick="mdocs_download_zip('mdocs-export.zip');" id="mdocs-export-submit" class="btn btn-primary" value="<?php _e('Export Memphis Documents Library','memphis-documents-library'); ?>"><br><br>
