		...
		<tr class="<?php echo $status_class; ?>">
			...
			foreach(get_option('mdocs-displayed-file-info') as $key => $option) {
				if(isset($option['show']) && $option['show']) {
					...
					?><td id="<?php echo $option['slug']; ?>"><i class="<?php echo $option['icon']; ?>" aria-hidden="true"></i> <em class="<?php echo $option['color']; ?>"><?php if(function_exists($the_function)) $the_function($the_mdoc); else echo '"'.$the_function. '" function does not exist.'; ?></em></td><?php
				}
			}
			?>
		</tr>
